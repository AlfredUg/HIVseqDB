...
from analysis.views import CreateNewAnalysisView, AnalysisResultsView, ProjectAnalysisResultsDetailView, SampleAnalysisResultsDetailView, ProjectMinorityVariantsView
...
urlpatterns = [
    ...
    path('analysis/minority-variants/<slug:project_ID>', ProjectMinorityVariantsView.as_view(), name='projectMinorityVariants'),
